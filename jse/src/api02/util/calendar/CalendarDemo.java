...
public class CalendarDemo {
	public static void main(String[] args) {
		...
		/*
		 * 위 결과를 그대로 출력하면 오늘날짜 : 2015년4월 29일 라고 나온다.
		...
		/*
		 프로그램 트라이얼 보면 3일 사용제한 같은 것이 걸린 것을 본 케이스라면 
		 30일 후의 시간을 자동으로 반환하는 로직도 필요합니다
		 아래와 같이 처리하면 됩니다.
		  */
		System.out.println("현재 기준 임의의 시간을 설정할 떄 " );
		...
		/*
		 스케줄 프로그램 작성할때 특정일자를 픽스해야 하는 경우에는 다음과 같이 처림
		 만약 22시 30분 45 초에 알람을 울리게 하는 기능을 주고자 할떄
		 */
