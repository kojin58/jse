...
/*
 java.lang.String
 charAt() : 지정된 위치에 있는 문자를 리턴한. index 는 0부터 시작
 index() : 주어진 문자가 존재하는지 확인하여 위치를 알려줌, 없으면 -1 반환
 */
public class CharAtDemo {
	public static void main(String[] args) {
		String ssn = "820110-2555555";
		/*
		 ssn.index("-")+1
		주민등록번호상의 "-" 의 위치를 (index) 리턴하는데
		"-"다른 숫자를 리턴하도록하기위해 +1를 준다.
		*/
		char isMan = ssn.charAt(ssn.indexOf("-")+1);
		/* char isMan = ssn.charAt(7);
		 * 위와값이 표현해도 무방하다.
		 * 인덱스 위치값이 0 부터 시작한다는 점과
		 * 파라미터 숫자값이 인덱스값을 의미한다는 점만 기억하면됨
		 */
	    switch (isMan){
	    /*
	     switch(조건식) 이 들어가며
